function output_signal = audio_spectral_subtraction(y,Fe,S) %%codegen

fprintf('--- Audio Signal Denoising using Spectral Subtraction ---\n\n'); 
%load noise sound example
[y,Fe]=audioread('noisy_speech_s0_n30_single.wav')
...
t_index=find(0.2>t_min & 0.2<t_max);
...
fprintf('\nPlay all seconds of the Original Sound:');
audioplayer(y(1:Fe),Fe);
fprintf(' OK\n');
fprintf('Play all seconds of the new Sound: ');
audioplayer(output_signal(1:Fe),Fe);
fprintf('OK\n');
